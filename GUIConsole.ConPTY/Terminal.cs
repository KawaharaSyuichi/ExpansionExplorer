...
namespace GUIConsole.ConPTY
{
    ...
    public sealed class Terminal
    {
        ...
        public void Start(string command, string workingDirectory, int consoleWidth = 80, int consoleHeight = 30)
        {
            ...
            using (var process = ProcessFactory.Start(command, PseudoConsole.PseudoConsoleThreadAttribute, pseudoConsole.Handle, workingDirectory))
            {
